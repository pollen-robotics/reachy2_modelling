...
def curves_reachable_set_dq_nd(robot, q0, time_horizon, q_max=None, q_min=None, dq_max= None, dq_min= None, options=None):
    ...
    x_curves = np.array([dk_position(robot.model,q, options['frame']).flatten() - x_0 for q in q_v])
